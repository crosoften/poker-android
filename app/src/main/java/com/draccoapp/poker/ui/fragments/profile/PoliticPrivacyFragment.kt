...
class PoliticPrivacyFragment : Fragment() {


    private var _binding: FragmentPoliticPrivacyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPoliticPrivacyBinding.inflate(inflater, container, false)
        return binding.root
    }
